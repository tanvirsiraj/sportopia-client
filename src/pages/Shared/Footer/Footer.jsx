...
const Footer = () => {
  return (
    <div>
      <footer className="footer px-4 py-10 lg:px-40 flex flex-col  lg:flex-row justify-between lg:py-10  primary-bg-color text-white">
      ...
      <footer className="footer footer-center p-4 bg-base-300 text-base-content">
        <div>
          <p className="font-semibold text-base">
            Copyright © 2023 - All right reserved by Sportopia
          </p>
        </div>
      </footer>
    </div>
